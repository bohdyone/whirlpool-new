...
!function(e,n){"function"==typeof define&&define.amd?define([],n):"object"==typeof exports?module.exports=n():e.humanTime=n()}(this,function(){"use strict";var e={zero:0,millisecond:" millisecond`",second:" second`",minute:" minute`",hour:" hour`",day:" day`",week:" week`",month:" month`",year:" year`"},n={millisecond:"s",second:"s",minute:"s",hour:"s",day:"s",week:"s",month:"s",year:"s"},t=function(e,n){this.name=e,this.time=n},i=[new t("millisecond",1),new t("second",1e3),new t("minute",6e4),new t("hour",36e5),new t("day",864e5),new t("week",6048e5),new t("month",2592e6),new t("year",31536e6)],r=function(e,n){return+e.toFixed(n)},o=function(e){return JSON.parse(JSON.stringify(e))},s=function(e,n){var t=o(e);if("object"==typeof n)for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i]);return t},u=function(t){t=t||{},this.names=s(e,t.names),this.plurals=s(n,t.plurals),"function"==typeof t.round?this.round=t.round:this.round=r,this.digits=t.digits};return u.prototype.print=function(n){if(n<1)return e.zero.toString();for(var t=0;t<i.length;++t){var r=i[t];if(n<r.time)return this._print(n,i[t-1])}return this._print(n,i[i.length-1])},u.prototype._print=function(e,n){var t=this.round(e/n.time,this.digits),i=this.names[n.name],r=1===t?"":this.plurals[n.name];return t+i.replace("`",r)},u});

},{}],5:[function(require,module,exports){
module.exports=require("./human-time");

},{"./human-time":4}],6:[function(require,module,exports){
...
},{"./_getNative":57,"./_root":89}],8:[function(require,module,exports){
...
},{"./_hashClear":61,"./_hashDelete":62,"./_hashGet":63,"./_hashHas":64,"./_hashSet":65}],9:[function(require,module,exports){
...
},{"./_listCacheClear":73,"./_listCacheDelete":74,"./_listCacheGet":75,"./_listCacheHas":76,"./_listCacheSet":77}],10:[function(require,module,exports){
var getNative=require("./_getNative"),root=require("./_root"),Map=getNative(root,"Map");module.exports=Map;

},{"./_getNative":57,"./_root":89}],11:[function(require,module,exports){
...
},{"./_mapCacheClear":78,"./_mapCacheDelete":79,"./_mapCacheGet":80,"./_mapCacheHas":81,"./_mapCacheSet":82}],12:[function(require,module,exports){
var getNative=require("./_getNative"),root=require("./_root"),Promise=getNative(root,"Promise");module.exports=Promise;

},{"./_getNative":57,"./_root":89}],13:[function(require,module,exports){
var getNative=require("./_getNative"),root=require("./_root"),Set=getNative(root,"Set");module.exports=Set;

},{"./_getNative":57,"./_root":89}],14:[function(require,module,exports){
...
},{"./_MapCache":11,"./_setCacheAdd":90,"./_setCacheHas":91}],15:[function(require,module,exports){
...
},{"./_ListCache":9,"./_stackClear":93,"./_stackDelete":94,"./_stackGet":95,"./_stackHas":96,"./_stackSet":97}],16:[function(require,module,exports){
...
},{"./_baseTimes":43,"./_isIndex":67,"./isArguments":108,"./isArray":109}],22:[function(require,module,exports){
...
},{"./_baseEach":25}],25:[function(require,module,exports){
...
},{"./_baseForOwn":27,"./_createBaseEach":49}],26:[function(require,module,exports){
...
},{"./_baseFor":26,"./keys":118}],28:[function(require,module,exports){
...
},{"./_castPath":46,"./_isKey":68,"./_toKey":99}],29:[function(require,module,exports){
...
},{"./_baseIsEqualDeep":32,"./isObject":114,"./isObjectLike":115}],32:[function(require,module,exports){
...
},{"./_Stack":15,"./_equalArrays":51,"./_equalByTag":52,"./_equalObjects":53,"./_getTag":58,"./_isHostObject":66,"./isArray":109,"./isTypedArray":117}],33:[function(require,module,exports){
...
},{"./_Stack":15,"./_baseIsEqual":31}],34:[function(require,module,exports){
...
},{"./_isHostObject":66,"./_isMasked":70,"./_toSource":100,"./isFunction":112,"./isObject":114}],35:[function(require,module,exports){
...
},{"./isLength":113,"./isObjectLike":115}],36:[function(require,module,exports){
...
},{"./_baseMatches":38,"./_baseMatchesProperty":39,"./identity":107,"./isArray":109,"./property":120}],37:[function(require,module,exports){
...
},{"./_isPrototype":71,"./_nativeKeys":86}],38:[function(require,module,exports){
...
},{"./_baseIsMatch":33,"./_getMatchData":56,"./_matchesStrictComparable":84}],39:[function(require,module,exports){
...
},{"./_baseIsEqual":31,"./_isKey":68,"./_isStrictComparable":72,"./_matchesStrictComparable":84,"./_toKey":99,"./get":104,"./hasIn":106}],40:[function(require,module,exports){
...
},{"./_Symbol":16,"./isSymbol":116}],45:[function(require,module,exports){
...
},{"./_stringToPath":98,"./isArray":109}],47:[function(require,module,exports){
var root=require("./_root"),coreJsData=root["__core-js_shared__"];module.exports=coreJsData;

},{"./_root":89}],48:[function(require,module,exports){
...
},{"./_arrayAggregator":19,"./_baseAggregator":24,"./_baseIteratee":36,"./isArray":109}],49:[function(require,module,exports){
...
},{"./isArrayLike":110}],50:[function(require,module,exports){
...
},{"./_SetCache":14,"./_arraySome":22}],52:[function(require,module,exports){
...
},{"./_Symbol":16,"./_Uint8Array":17,"./_equalArrays":51,"./_mapToArray":83,"./_setToArray":92,"./eq":102}],53:[function(require,module,exports){
...
},{"./keys":118}],54:[function(require,module,exports){
(function (global){
...
},{"./_isKeyable":69}],56:[function(require,module,exports){
...
},{"./_isStrictComparable":72,"./keys":118}],57:[function(require,module,exports){
...
},{"./_baseIsNative":34,"./_getValue":59}],58:[function(require,module,exports){
...
},{"./_DataView":7,"./_Map":10,"./_Promise":12,"./_Set":13,"./_WeakMap":18,"./_baseGetTag":29,"./_toSource":100}],59:[function(require,module,exports){
...
},{"./_castPath":46,"./_isIndex":67,"./_isKey":68,"./_toKey":99,"./isArguments":108,"./isArray":109,"./isLength":113}],61:[function(require,module,exports){
...
},{"./isArray":109,"./isSymbol":116}],69:[function(require,module,exports){
...
},{"./isObject":114}],73:[function(require,module,exports){
...
},{"./_assocIndexOf":23}],77:[function(require,module,exports){
...
},{"./_Hash":8,"./_ListCache":9,"./_Map":10}],79:[function(require,module,exports){
...
},{"./_getMapData":55}],80:[function(require,module,exports){
...
},{"./_getNative":57}],86:[function(require,module,exports){
var overArg=require("./_overArg"),nativeKeys=overArg(Object.keys,Object);module.exports=nativeKeys;

},{"./_overArg":88}],87:[function(require,module,exports){
...
},{"./_freeGlobal":54}],88:[function(require,module,exports){
...
},{"./_freeGlobal":54}],90:[function(require,module,exports){
...
},{"./_ListCache":9}],94:[function(require,module,exports){
...
},{"./_ListCache":9,"./_Map":10,"./_MapCache":11}],98:[function(require,module,exports){
...
},{"./memoize":119,"./toString":125}],99:[function(require,module,exports){
...
},{"./isSymbol":116}],100:[function(require,module,exports){
...
},{"./_arrayEach":20,"./_baseEach":25,"./_baseIteratee":36,"./isArray":109}],104:[function(require,module,exports){
function get(e,t,r){var a=null==e?void 0:baseGet(e,t);return void 0===a?r:a}var baseGet=require("./_baseGet");module.exports=get;

},{"./_baseGet":28}],105:[function(require,module,exports){
...
},{"./_createAggregator":48}],106:[function(require,module,exports){
...
},{"./_baseHasIn":30,"./_hasPath":60}],107:[function(require,module,exports){
...
},{"./isArrayLikeObject":111}],109:[function(require,module,exports){
...
},{"./isFunction":112,"./isLength":113}],111:[function(require,module,exports){
...
},{"./isArrayLike":110,"./isObjectLike":115}],112:[function(require,module,exports){
...
},{"./isObjectLike":115}],117:[function(require,module,exports){
...
},{"./_baseIsTypedArray":35,"./_baseUnary":45,"./_nodeUtil":87}],118:[function(require,module,exports){
...
},{"./_arrayLikeKeys":21,"./_baseKeys":37,"./isArrayLike":110}],119:[function(require,module,exports){
...
},{"./_baseProperty":40,"./_basePropertyDeep":41,"./_isKey":68,"./_toKey":99}],121:[function(require,module,exports){
...
},{"./_baseSlice":42,"./toInteger":123}],122:[function(require,module,exports){
...
},{"./isObject":114,"./isSymbol":116}],125:[function(require,module,exports){
...
},{"_process":3,"events":2}],127:[function(require,module,exports){
...
},{"./AsyncWriter":126}],128:[function(require,module,exports){
...
},{"./escapeXml":129}],129:[function(require,module,exports){
...
},{"./extend":130}],132:[function(require,module,exports){
...
},{"./":134,"raptor-util/attr":128,"raptor-util/escapeXml":129}],133:[function(require,module,exports){
...
},{"./helpers":132,"./loader":133,"async-writer":127,"raptor-util/extend":130,"raptor-util/inherit":131}],135:[function(require,module,exports){
...
},{"./common.js":137,"./templates/crumb.marko.js":140,"lodash/each":101,"marko":134}],137:[function(require,module,exports){
function state(){return _state}function config(){return _config}function log(e){_config.DEBUG&&console.log(e)}function timing(){return _timing}function logTiming(e,n){var t=Date.now();_timing[e]=t,log("Time for "+e+": "+(t-n))}function router(){return _router}function ajax(e,n,t){aja().url(e).on("success",n).on("error",t).go()}function handleError(){log("server error"),null===_state.retryPendingId&&(_state.retryPendingId=setTimeout(function(){log("retrying "+location.hash),_state.retryPendingId=null,_router.processHash()},_config.ERROR_RETRY_DELAY))}function buildServiceUrl(e){function n(e){var n=[];for(var t in e)n.push(encodeURIComponent(t)+"="+encodeURIComponent(e[t]));return n.join("&")}var t=_config.API_KEY,o="json",r=n(e),i="https://whirlpool.net.au/api/?key="+t+"&"+r+"&output="+o;return i}function showLoading(e){var n=document.getElementById("content");if(null!==n)if(e)n.className="content faded_out",_state.loadPendingId=setTimeout(function(){var e=document.getElementById("content_loader");e.className="loader faded_in"},_config.LOAD_ANIM_DELAY);else{n.className="content faded_in";var t=document.getElementById("content_loader");t.className="loader faded_out",null!==_state.loadPendingId&&(clearTimeout(_state.loadPendingId),_state.loadPendingId=null)}}function slashFilter(e){return"string"==typeof e?e.replace(/\//g," "):e}function checkDomLoaded(e){"complete"===document.readyState?e():(log("dom not ready"),domready(e))}function setContent(e,n){document.getElementById(n).innerHTML=e,showLoading(!1)}function timeSince(e){var n=new Date,t=new Date(e),o=n-t;if(o<1e4)return"moments ago";var r=new HumanTime;return r.print(o)+" ago"}module.exports={state:state,log:log,handleError:handleError,slashFilter:slashFilter,ajax:ajax,showLoading:showLoading,checkDomLoaded:checkDomLoaded,setContent:setContent,logTiming:logTiming,buildServiceUrl:buildServiceUrl,router:router,timing:timing,config:config,timeSince:timeSince};var aja=require("aja"),domready=require("domready"),HumanTime=require("custom-human-time"),_state={forumList:{forums:null,threads:null},retryPendingId:null},_config={DEBUG:!0,LOAD_ANIM_DELAY:500,ERROR_RETRY_DELAY:2e3,API_KEY:null},_timing={},Rlite=require("rlite-router"),_router=new Rlite;

},{"aja":1,"custom-human-time":5,"domready":6,"rlite-router":135}],138:[function(require,module,exports){
function showForumList(){common.showLoading(!0),common.logTiming("start"),loadForumListThreads(),null===common.state().forumList.forums&&common.ajax(common.buildServiceUrl({get:"forum"}),processForumData,common.handleError)}function loadForumListThreads(){common.ajax(common.buildServiceUrl({get:"threads",threadcount:100}),processForumThreads,common.handleError)}function processForumThreads(o,m){common.state().forumList.threads=o.THREADS,null!==common.state().forumList.forums&&processForumListAndThreads()}function processForumData(o,m){common.state().forumList.forums=o.FORUM,null!==common.state().forumList.threads&&processForumListAndThreads()}function processForumListAndThreads(){common.logTiming("load",common.timing().start);var o=common.state().forumList.forums,m=common.state().forumList.threads,r=[],e=[],s=_.groupBy(o,function(o){return o.SECTION}),n=_.groupBy(m,function(o){return o.FORUM_ID}),t=1;_.each(o,function(o){o.ID in n&&(o.THREADS=_.take(n[o.ID],3))});for(var i in s){var c={SECTION:i,FORUMS:s[i]};"Mobile"==i&&(t=2),1==t?r.push(c):e.push(c)}var a={COLUMNS:[r,e],slashFilter:common.slashFilter,timeSince:common.timeSince};common.logTiming("process",common.timing().load);var u=marko.load(forumListTpl);common.logTiming("compile",common.timing().process),u.render(a,function(o,m,r){common.checkDomLoaded(function(){breadcrumbs.setBreadcrumbs([]),common.setContent(m,"content")}),common.logTiming("render",common.timing().compile),common.logTiming("totalTime",common.timing().start)})}exports.showForumList=showForumList;var marko=require("marko"),_={each:require("lodash/each"),take:require("lodash/take"),groupBy:require("lodash/groupBy")},common=require("./common.js"),breadcrumbs=require("./breadcrumbs.js"),forumListTpl=require("./templates/forumList.marko.js");
},{"./breadcrumbs.js":136,"./common.js":137,"./templates/forumList.marko.js":141,"lodash/each":101,"lodash/groupBy":105,"lodash/take":121,"marko":134}],139:[function(require,module,exports){
function getCookies(){var o={};if(!document.cookie)return o;var i=document.cookie.split(";");return i.forEach(function(i){var e=i.split("=");2==e.length&&(o[String(e[0]).trim()]=e[1])}),o}function initRouter(o){o.add("",function(){forumList.showForumList()}),o.add("forum/:forumId/:forumName",function(o){threadList.showThreadList(o.params.forumId)}),o.processHash=function(){var i=location.hash||"#";o.run(i.slice(1))},window.addEventListener("hashchange",o.processHash),o.processHash()}var threadList=require("./threadList.js"),forumList=require("./forumList.js"),common=require("./common.js"),config=common.config(),cookies=getCookies();"WP_API_KEY"in cookies&&"null"!=cookies.WP_API_KEY?config.API_KEY=cookies.WP_API_KEY:(config.API_KEY=window.prompt("Plase enter your API key."),document.cookie="WP_API_KEY="+config.API_KEY),initRouter(common.router());
},{"./common.js":137,"./forumList.js":138,"./threadList.js":143}],140:[function(require,module,exports){
(function (__filename){
...
},{"marko":134}],141:[function(require,module,exports){
(function (__filename){
function create(t){var e=t.s,i=(t.e,t.ne,t.x),a=t.f,l=t.xa;return function(t,s){s.w('<div id="forumindex"> '),a(t.COLUMNS,function(o){s.w('<div class="column"> <div class="inner"> '),a(o,function(o){s.w('<div class="section"> <h3>'+i(o.SECTION)+'</h3> <table> <colgroup> <col class="title"> <col class="threads"> </colgroup> <tbody> '),a(o.FORUMS,function(o){s.w('<tr> <td class="title" title="n threads, x posts"> <div class="title"><a href="#forum/'+l(o.ID)+"/"+l(t.slashFilter(o.TITLE))+'">'+i(o.TITLE)+'</a></div> </td> <td class="threads"> '),a(o.THREADS,function(a){s.w('<div><a href="https://forums.whirlpool.net.au/forum-replies.cfm?t='+l(a.ID)+'&amp;p=-1&amp;#bottom">'+e(a.TITLE)+"</a> ("+i(t.timeSince(a.LAST_DATE))+")</div>")}),s.w(" </td> </tr>")}),s.w(" </tbody> </table> </div>")}),s.w(" </div> </div>")}),s.w(' <br clear="all"> </div>')}}(module.exports=require("marko").c(__filename)).c(create);

}).call(this,"/src\\templates\\forumList.marko.js")
},{"marko":134}],142:[function(require,module,exports){
(function (__filename){
function create(s){var t=s.s,e=(s.e,s.ne,s.x),a=s.f,l=s.xa;return function(s,r){r.w('<div id="threads" class="pagefit"> <table class="showvisited"> <colgroup> <col class="title"> <col class="reps"> <col class="reads"> <col class="oldest"> <col class="newest"> <col class="goend"> </colgroup> <thead> <tr> <td class="title">&nbsp;</td> <td class="reps"><b>Replies</b></td> <td class="reads"><b>Seen&nbsp;by</b></td> <td class="oldest"><b>First Post</b></td> <td class="newest"><b>Last Post</b></td> <td class="goend">&nbsp;</td> </tr> </thead> <tbody> <tr class="sticky  closed "> <td class="title"> <a class="title" href="/forum-replies.cfm?t=1901362">Sticky</a> <span class="small" style="color:#669;">&nbsp;[closed]</span> </td> <td class="reps tint0">null</td> <td class="reads tint9">null</td> <td class="oldest"><a href="/user/96148">Percussive Maintenance</a> <br>2012-Apr-16, 7:56 pm</td> <td class="newest thesame"><span><a href="/user/96148">Percussive Maintenance</a><br>2012-Apr-16, 7:56 pm</span></td> <td class="goend  "><a href="/forum-replies.cfm?t=1901362&amp;amp;p=-1&amp;amp;#bottom" title="Jump to last post">&#9654;</a></td> </tr> '),a(s.THREADS,function(a){r.w('<tr class=""> <td class="title"> '),a.GROUP&&r.w('<a class="group" href="#forum/'+l(a.FORUM_ID)+'">'+t(a.GROUP)+"</a>"),r.w(' <a class="title" href="https://forums.whirlpool.net.au/forum-replies.cfm?t='+l(a.ID)+'">'+t(a.TITLE)+'</a> </td> <td class="reps tint0">'+e(a.REPLIES)+'</td> <td class="reads tint0">null</td> <td class="oldest"><a href="#">null</a> <br>OldestTime</td> <td class="newest "><span><a href="https://forums.whirlpool.net.au/user/'+l(a.LAST.ID)+'">'+e(a.LAST.NAME)+"</a><br>"+e(s.timeSince(a.LAST_DATE))+'</span></td> <td class="goend  "><a href="https://forums.whirlpool.net.au/forum-replies.cfm?t='+l(a.ID)+'&amp;p=-1&amp;#bottom" title="Jump to last post">&#9654;</a></td> </tr>')}),r.w(" </tbody> </table> </div>")}}(module.exports=require("marko").c(__filename)).c(create);

}).call(this,"/src\\templates\\threadList.marko.js")
},{"marko":134}],143:[function(require,module,exports){
function showThreadList(o){common.timing().startLoad=Date.now(),common.showLoading(!0),common.log("loading threads");common.ajax(common.buildServiceUrl({get:"threads",forumids:o,threadcount:100}),processThreadData,common.handleError)}function processThreadData(o,m){common.logTiming("load",common.timing().startLoad);var e="",r=marko.load(threadListTpl);o.timeSince=common.timeSince,r.render(o,function(m,r,a){common.checkDomLoaded(function(){o.THREADS.length>0&&(e=o.THREADS[0].FORUM_NAME,breadcrumbs.setBreadcrumbs([{Name:"Forums",URL:"#"},{Name:e}])),scroll(0,0),common.setContent(r,"content")}),common.logTiming("render",common.timing().load)})}exports.showThreadList=showThreadList;var marko=require("marko"),threadListTpl=require("./templates/threadList.marko.js"),common=require("./common.js"),breadcrumbs=require("./breadcrumbs.js");

},{"./breadcrumbs.js":136,"./common.js":137,"./templates/threadList.marko.js":142,"marko":134}]},{},[139]);
